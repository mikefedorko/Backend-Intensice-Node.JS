...
describe('video delete by hash', () => {
    ...
    test('should return 204 for deleting video by hash', async (done) => {
        const response = await server.delete('/lessons/:lessonHash/videos/:videoHash');
